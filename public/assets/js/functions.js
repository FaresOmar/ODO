...
$(document).ready(function() {
    ...
    jQuery(".product-img .product-favourite .favourite").click(function() {
    ...
    if ($("body").hasClass("equalize-active")) {
    ...
    $('.add-part').click(function(){
      ...
      var $div = $('div[id^="spare-part-single"]:last');
      ...
      var $klon = $div.clone().prop('id', 'spare-part-single'+num );

      // Finally insert $klon wherever you want
      $div.after( $klon );

      $('div[id^="spare-part-single"]:last #part').val('');
      $('div[id^="spare-part-single"]:last input[type="file"]').prop("id", "imgInp"+num);
      $('div[id^="spare-part-single"]:last label').prop("for", "imgInp"+num);
    ...
    $('.add-car').click(function(){
      ...
      // get the last DIV which ID starts with ^= "klon"
      var $div = $('div[id^="car-single"]:last');
      ...
      // Clone it and assign the new ID (i.e: from num 4 to ID "klon4")
      var $klon = $div.clone().prop('id', 'car-single'+num );
     ...
     $('.add-accessory').click(function(){
      ...
      // get the last DIV which ID starts with ^= "klon"
      var $div = $('div[id^="accessory-part-single"]:last');
      ...
      // Clone it and assign the new ID (i.e: from num 4 to ID "klon4")
      var $klon = $div.clone().prop('id', 'accessory-part-single'+num );

      // Finally insert $klon wherever you want
      $div.after( $klon );

      $('div[id^="accessory-part-single"]:last #part').val('');
      $('div[id^="accessory-part-single"]:last input[type="file"]').prop("id", "imgInp_access"+num);
      $('div[id^="accessory-part-single"]:last label').prop("for", "imgInp_access"+num);
    });
     ...
     jQuery('#typeselect').on('change',function(){
        ...
        if( jQuery(this).val()==="Spare_Parts"){
            jQuery(".spare-part-div, .submit-btn").fadeIn();
            jQuery(".batteries-div, .tyres-div, .accessories-div").fadeOut();
            // console.log("Spare_Parts");
        }
        else if( jQuery(this).val()==="batteries"){
            jQuery(".batteries-div, .submit-btn").fadeIn();
            jQuery(".spare-part-div, .tyres-div, .accessories-div").fadeOut();
            // console.log("batteries");
        }
        else if( jQuery(this).val()==="tyres"){

            jQuery(".tyres-div, .submit-btn").fadeIn();
            jQuery(".spare-part-div, .batteries-div, .accessories-div").fadeOut();
            // console.log("tyres");
        }
        else if( jQuery(this).val()==="accessories"){

            jQuery(".accessories-div, .submit-btn").fadeIn();
            jQuery(".spare-part-div, .batteries-div, .tyres-div ").fadeOut();
            // console.log("accessories");
        }
        else{

            jQuery(".submit-btn").fadeOut();
        }
    });

    jQuery('input[type="radio"]').click(function() {
       if(jQuery(this).attr('id') == 'know_battery') {
            jQuery(".know-battery-div").fadeIn();
       }

       else if(jQuery(this).attr('id') == 'dntknow_battery'){
            jQuery(".know-battery-div").fadeOut();
       }
   });


    // jQuery('.add-part').click(function() {
    //      jQuery(".add-part-div").fadeOut();
    //      jQuery(".another-part").fadeIn();
    // });
    ...
    function readURL2(input) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
          $('#preview-img-2').attr('src', e.target.result);
        }
    ...
    function readURL3(input) {
      ...
      if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
          $('#preview-img_access').attr('src', e.target.result);
        }
    ...
    $sliderAmount.val("EGP " + $sliderRange.slider("values", 0) + " - EGP " + $sliderRange.slider("values", 1));
